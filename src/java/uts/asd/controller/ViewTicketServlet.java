...
public class ViewTicketServlet extends HttpServlet {
    ...
    public void doPost(HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException {
        ...
        String StatusInput = request.getParameter("Cancelled");
        ...
        validator.clear(session);
            ...
            try {
                manager.cancelHelpTicket(StatusInput, HelpTicketInput);
                response.sendRedirect("ViewTicketServlet?Ticketid="+HelpTicketInput);
            }
    ...
    public void doGet(HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException {
        ...
        try {
            ...
            request.getRequestDispatcher("viewHelpTicket.jsp").include(request, response);
        } catch (SQLException ex) {
